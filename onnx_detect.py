...
def load_model(path):
    session = onnxruntime.InferenceSession(path, providers=['TensorrtExecutionProvider', 'CUDAExecutionProvider', 'CPUExecutionProvider'])
...
def test_video(det, video_path, save_path=None):
    ...
    while True:
        ...
        if save_path is None:  # new video
            save_path = video_path[:video_path.rfind('.')] + '_detected.mp4'
...
if __name__ == '__main__':
    ...
    test_video(detector, "data/DJI_20220420135224_0003_S.MP4")
